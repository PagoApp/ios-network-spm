...
#ifndef PAGOAPICLIENT_SWIFT_H
#define PAGOAPICLIENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PagoApiClient",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC13PagoApiClient14CountryManager")
...
SWIFT_CLASS("_TtC13PagoApiClient10ErrorCodes")
@interface ErrorCodes : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger InvalidPin;)
+ (NSInteger)InvalidPin SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger ExceededNumberOfRetries;)
+ (NSInteger)ExceededNumberOfRetries SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC13PagoApiClient10PagoConfig")
@interface PagoConfig : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Responsible for handling all delegate callbacks for the underlying session.
SWIFT_CLASS("_TtC13PagoApiClient15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(PagoApiClient)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PagoApiClient)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PagoApiClient)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PagoApiClient)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PagoApiClient)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC13PagoApiClient15SharedConstants")
@interface SharedConstants : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull remainingAttempts;)
+ (NSString * _Nonnull)remainingAttempts SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC13PagoApiClient12TaskDelegate")
